...
<div class="subsubsub_section">
    ...
    <div class="section">
        ...
        <h3 style="margin-bottom: 1px;">WOOCS - <?php printf(__('WooCommerce Currency Switcher v.%s', 'woocommerce-currency-switcher'), WOOCS_VERSION) ?></h3>
        ...
        <div id="tabs" class="wfc-tabs wfc-tabs-style-shape" >
            ...
            <div class="content-wrap">
                ...
                <section id="tabs-5">
                    ...
                    <ul>
                        <li class="woocs_help_links">
                            <a href="http://currency-switcher.com/documentation/" target="_blank" class="button"><?php _e("Documentation", 'woocommerce-currency-switcher') ?></a>
                            ...
                            &nbsp; <a href="http://en.wikipedia.org/wiki/ISO_4217#Active_codes" target="_blank" class="button button-primary button-large"><?php _e("Read wiki about Currency Active codes  <-  Get right currencies codes here", 'woocommerce-currency-switcher') ?></a>
                            &nbsp; <a href="http://currency-switcher.com/i-cant-add-flags-what-to-do/" target="_blank" class="button"><?php _e("I cant add flags! What to do?", 'woocommerce-currency-switcher') ?></a>
                            ...
                            &nbsp; <a href="https://currency-switcher.com/woocs-labs/" target="_blank" class="button button-primary button-large"><?php _e("One of my plugins not compatible with WOOCS. What to do?", 'woocommerce-currency-switcher') ?></a>
                            &nbsp; <a href="https://currency-switcher.com/wp-content/uploads/2017/09/woocs-options.png" target="_blank" class="button"><?php _e("The plugin options example screen", 'woocommerce-currency-switcher') ?></a>
                            <br /><br />
                        </li>
                        ...
                        <?php if (!$WOOCS->notes_for_free): ?>
                            <li>
                                <div id="plugin_warning" style="padding: 9px; border: solid red 3px; background: #eee; ">
                                    <div class="plugin_warning_head"><strong style="color: red;">ATTENTION MESSAGE FROM THE PLUGIN AUTHOR TO ALL USERS WHO DOWNLOADED THE PLUGIN NOT FROM THE OFFICIAL SITES! IF YOU BOUGHT IT - DO NOT READ AND IGNORE IT!</strong>!<br></div>
                                    <br />
    ...
    <?php if ($WOOCS->notes_for_free): ?>
        ...
        <i style="color: red;">In the free version of the plugin you can operate with 2 ANY currencies only. If you want more currencies and features you can make upgrade to <a href="http://codecanyon.net/item/woocommerce-currency-switcher/8085217?ref=realmag777" target="_blank">the premium version of the plugin</a></i><br />
