...
function ssm_form_edit_meta($post){
 ...
 //////////////////////////////////////////////////////////////////////////
    ...
    $smf_mailchimp_method = '<form id="sm_form" action='.$msm_action_url.' method="post" class="myform" >';
    $smf_getresponse_method = '<form id="sm_form" action='.$gsm_action_url.' method="post" class="myform" >';
