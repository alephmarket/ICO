...
<div id='lpp_wrapper' class='formLayout_s_l'>
    ...
    <div id='lpp_left'>
       ...
       checked >
        ...
        Template -10
        <input type="radio" id='lpp_select_template10' name='ssm_select_form_template' value='form_9.php'
        <?php checked( "form_9.php", $ssm_select_form_template); ?>
        >
        <label for='lpp_select_template10'>
            <img src="<?php echo plugins_url('img/ssm-thumbs-10.png',__FILE__); ?>" class='ssm_thumb' >
        </label>
        Template -13
        <input type="radio" id='lpp_select_template13' name='ssm_select_form_template' value='form_13.php'
        ...
        Template -11
        <input type="radio" id='lpp_select_template11' name='ssm_select_form_template' value='form_11.php'
...
<div id='lpp_row_3'>
    Template -3
        ...
        Template -9
        <input type="radio" id='lpp_select_template9' name='ssm_select_form_template' value='form_10.php'
        ...
        <label for='lpp_select_template9'>
         ...
         Template -12
        <input type="radio" id='lpp_select_template12' name='ssm_select_form_template' value='form_12.php'
