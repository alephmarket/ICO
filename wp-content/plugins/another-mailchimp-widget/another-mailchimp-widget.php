...
//register_deactivation_hook( __FILE__, array( 'Another_mailChimp_widget', 'on_deactivation' ) );
//register_uninstall_hook( __FILE__, array( 'Another_mailChimp_widget', 'on_uninstall' ) );
