 ...
 * Utm_Switcher_Plugin_Requirements: only required the declaration, check the minimum value inserted, call directly the warning
 * Utm_Switcher_Plugin_requirements: support multiple plugin
 * Utm_Switcher_Requirement_Error: compacted code, better css, added deactivation of the plugin
 */

if ( class_exists( 'Utm_Switcher_Plugin_Requirements' ) === false ) {
     ...
     *  'PHP' => new Utm_Switcher_PHP_Requirement( '5.9.0' ),
     * 	'WP' => new Utm_Switcher_WordPress_Requirement( '3.9.0' ),
     *  'Extension' => new Utm_Switcher_PHP_Extension_Requirement( array('mysql', 'mysqli', 'session', 'pcre','json', 'gd', 'mbstring', 'zlib' ),
     *  'Plugin' => new Utm_Switcher_Plugin_Requirement( array( 
     ...
     */
    class Utm_Switcher_Plugin_Requirements {
         ...
         * 
         * @param    string    $pluginname The UTM Switcher used for the warning
        ...
        function getRequirements() {
            ...
            if ( !isset( $requirements[ 'PHP' ] ) ) {
                $requirements[ 'PHP' ] = new Utm_Switcher_PHP_Requirement( '5.2.0' );
            }

            if ( !isset( $requirements[ 'WP' ] ) ) {
                $requirements[ 'WP' ] = new Utm_Switcher_WordPress_Requirement( '4.0.0' );
            }

            if ( !isset( $requirements[ 'Extension' ] ) ) {
                $requirements[ 'Extension' ] = new Utm_Switcher_PHP_Extension_Requirement( array(
        ...
        public function satisfied() {
            ...
            if ( !$success ) {
                new Utm_Switcher_Requirement_Error( $this->pluginName, $this->pluginSlug, $results );
            }
     ...
     * @author  Mte90 and dsawardekar
     */
    class Utm_Switcher_PHP_Requirement {
     ...
     * @author  Mte90 and dsawardekar
     */
    class Utm_Switcher_WordPress_Requirement {
     ...
     * @author  Mte90 and dsawardekar
     */
    class Utm_Switcher_PHP_Extension_Requirement {
     ...
     * @author  Mte90 and dsawardekar
     */
    class Utm_Switcher_Plugin_Requirement {
     ...
     * @author  Mte90 and dsawardekar
     */
    class Utm_Switcher_Plugin_Requirements_Exception extends \Exception {
     ...
     * @author  Mte90 and dsawardekar
     */
    class Utm_Switcher_Requirement_Error {
        ...
        function showError( $message ) {
            if ( $this->isErrorScraper() ) {
                ...
                throw new Utm_Switcher_Plugin_Requirements_Exception();
            }
        }
