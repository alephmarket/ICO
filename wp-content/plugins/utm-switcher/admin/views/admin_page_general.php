...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		<a href="<?php echo esc_html( admin_url( 'edit.php?post_type=utm_switcher&page=utm_switcher_ref_general' ) ); ?>" class="nav-tab nav-tab-active"><?php esc_attr_e( 'General', 'utm-switcher' ); ?></a>
		<a href="<?php echo esc_html( admin_url( 'edit.php?post_type=utm_switcher&page=utm_switcher_ref_cf7' ) ); ?>" class="nav-tab"><?php esc_attr_e( 'Contact Form 7', 'utm-switcher' ); ?></a>
	</h2>
