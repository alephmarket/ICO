...
// return tg-text-domain
function tgTextDomain($val)
{
    return __( $val, 'tg-text-domain' );
}
...
$grid_settings = array(
		...
		'fields' => array(	
            ...
            array(
                'id'   => 'section_modal_window_general_start',
                'name' => __( 'General', 'tg-text-domain'   ),
                'desc' => __( 'General settings', 'tg-text-domain' ),
                'sub_desc' => '',
                'type' => 'section_start',
                'color' => '#ffffff',
                'background' => '#34495e',
                'tab' => __( 'Ajax card', 'tg-text-domain' )
            ),
            array(
                'id'   => $prefix.'modal_window_info',
                'name' => __( 'Ajax card', 'tg-text-domain' ),
                'desc' => __( 'In this section you can turn on the THEMO Ajax Card for portfolio posts (items) displayed in this grid.<br>!!! REMEMBER that Ajax Card works only for portfolio posts (items). Customization options for Ajax Card (like fonts and colors) are available in Portfolio post options, in \'Modern title area\' tab.', 'tg-text-domain' ),
                'type' => 'custom',
                'std' => '',
                'options' => '',
                'tab' => __( 'Ajax card', 'tg-text-domain' )
            ...
            array(
                'id'   => $prefix.'modal_window_enabled',
                'name' => __( 'Enabled', 'tg-text-domain' ),
                'desc' => __( 'Turn on/off ajax card functionality.', 'tg-text-domain' ),
                'type' => 'checkbox',
                'std' => '',
                'tab' => __( 'Ajax card', 'tg-text-domain' )
            ),
            ...
            array(
                'id'   => $prefix.'modal_window_linking_css_selector',
                'name' => __( 'Custom linking CSS selectors', 'tg-text-domain' ),
                'desc' => __( 'Enter your custom CSS separate selectors with commas which is used for linking with the modal window.', 'tg-text-domain' ),
                'type' => 'text',
                'disabled' => false,
                'std' => '',
                'tab' => __( 'Ajax card', 'tg-text-domain' ),
            ...
            array(
                'id'   => 'section_modal_window_general_end',
                'type' => 'section_end',
                'tab' => __( 'Ajax card', 'tg-text-domain' ),
                'tab_icon' => '<i class="tomb-icon dashicons dashicons-admin-tools"></i>'
            ),
            array(
                'id'   => 'section_modal_window_effects_start',
                'name' => __( 'Effects', 'tg-text-domain'   ),
                'desc' => __( 'Set effects of the modal window', 'tg-text-domain' ),
                'sub_desc' => '',
                'type' => 'section_start',
                'color' => '#ffffff',
                'background' => '#34495e',
            ...
            array(
                'id'   => $prefix.'modal_window_easing_in',
                'name' => __( 'Easing in', 'tg-text-domain' ),
                'desc' => __( 'Select easing in effect.', 'tg-text-domain' ) .'&nbsp;&nbsp;&nbsp;&nbsp;',
                'type' => 'select',
                'clear' => true,
                'placeholder' => __( 'Select the effect', 'tg-text-domain' ),
                'width' => 180,
                'options' => array_combine($fadeEffects, array_map('tgTextDomain', $fadeEffects)),
                'tab' => __( 'Ajax card', 'tg-text-domain' )
            ),
            array(
                'id'   => $prefix.'modal_window_easing_in_duration',
                'name' => __( 'Easing in duration', 'tg-text-domain' ),
                'desc' => __( 'Type easing in duration (seconds).', 'tg-text-domain' ),
                'type' => 'text',
                'disabled' => false,
                'std' => '1.5',
                'tab' => __( 'Ajax card', 'tg-text-domain' ),
            ...
            array(
                'id'   => $prefix.'modal_window_easing_out',
                'name' => __( 'Easing out', 'tg-text-domain' ),
                'desc' => __( 'Select easing out effect.', 'tg-text-domain' ) .'&nbsp;&nbsp;&nbsp;&nbsp;',
                'type' => 'select',
                'clear' => true,
                'placeholder' => __( 'Select the effect', 'tg-text-domain' ),
                'width' => 180,
            ...
            array(
                'id'   => $prefix.'modal_window_easing_out_duration',
                'name' => __( 'Easing out duration', 'tg-text-domain' ),
                'desc' => __( 'Type easing out duration (seconds).', 'tg-text-domain' ),
                'type' => 'text',
                'disabled' => false,
                'std' => '1.5',
                'tab' => __( 'Ajax card', 'tg-text-domain' ),
            ...
            array(
                'id'   => 'section_modal_window_effects_end',
                'type' => 'section_end',
                'tab' => __( 'Ajax card', 'tg-text-domain' ),
                'tab_icon' => '<i class="tomb-icon dashicons dashicons-admin-tools"></i>'
            ),
